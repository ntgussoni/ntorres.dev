...
description: "Use hooks.json to intercept, block, and extend what Cursor and Claude Code agents do: shell gating, auto-formatting, audit logs, and more."
image: card.png
draft: false
categories:
  - ai
...
Each recipe includes the `hooks.json` entry and a hook script. Put scripts in `.cursor/hooks/` and `chmod +x` them. Recipes 1-5 are the essentials; 6-8 come from [official Cursor docs](https://cursor.com/docs/agent/hooks).
