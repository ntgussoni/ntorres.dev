---
date: 06/07/2026
title: "Cursor hooks.json: JSON Schema, Events & Payloads"
description: "The complete hooks.json reference: every Cursor and Claude Code hook event, stdin JSON payload shape, exit codes, matchers, and copy-paste recipes."
image: card.png
draft: false
categories:
  - ai
