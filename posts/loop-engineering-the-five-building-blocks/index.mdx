---
date: 21/06/2026
title: "Loop Engineering: The Five Building Blocks + Memory"
...
The primitive names and roles follow [Cobus Greyling's loop-engineering reference repo](https://github.com/cobusgreyling/loop-engineering) ([`docs/primitives.md`](https://github.com/cobusgreyling/loop-engineering/blob/main/docs/primitives.md), MIT license).
...
*Sources: [Addy Osmani's Loop Engineering](https://addyosmani.com/blog/loop-engineering/). The six-primitive model from [Cobus Greyling's loop-engineering repo](https://github.com/cobusgreyling/loop-engineering) (MIT). [Cobus Greyling's Loop Engineering essay](https://cobusgreyling.substack.com/p/loop-engineering).*
