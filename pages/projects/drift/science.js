...
const Section = ({ title, children }) => (
  <section className="mb-12">
    <h2 className="text-xl md:text-2xl font-semibold font-roboto mb-4 text-neutral-900">
      {title}
    </h2>
    {children}
  </section>
...
const H3 = ({ children }) => (
  <h3 className="text-lg font-semibold text-neutral-900 mb-3 mt-6">{children}</h3>
);
...
const Table = ({ children }) => (
  <div className="overflow-x-auto my-4">
    <table className="w-full border-collapse border border-neutral-200 text-left text-sm">
      {children}
    </table>
  </div>
);
...
const Th = ({ children, className = '' }) => (
  <th
    className={`py-2 px-3 border-b border-neutral-200 bg-neutral-100 font-semibold text-neutral-900 ${className}`}
  >
    {children}
  </th>
);
...
const Td = ({ children, className = '' }) => (
  <td className={`py-2 px-3 border-b border-neutral-200 text-neutral-600 ${className}`}>
    {children}
  </td>
);
    ...
    <Layout title="Drift — Science">
      ...
      <article className="max-w-3xl mx-auto w-full">
        <p className="text-sm text-neutral-500 mb-2">
          <Link href="/projects/drift" className="hover:text-neutral-700">
            ← Drift
          </Link>
        </p>
        <h1 className="text-3xl font-bold font-roboto mb-4 text-neutral-900">
          The science behind Drift
        </h1>
        <P>
          Drift is built on a specific, peer-reviewed sleep technique called{' '}
          <strong className="text-neutral-900">Serial Diverse Imagining (SDIT)</strong>{' '}
        ...
        <Section title="The core problem: pre-sleep cognitive arousal">
          ...
          <P>
            <strong className="text-neutral-900">Pre-sleep cognitive arousal</strong>{' '}
        ...
        <Section title="The theoretical framework">
          ...
          <Table>
            ...
            <tbody>
              <tr>
                <Td className="font-medium text-neutral-900">Somnolent mentation</Td>
                <Td>Mental activity that facilitates sleep onset</Td>
                <Td>Positive</Td>
              </tr>
              <tr>
                <Td className="font-medium text-neutral-900">Asomnolent mentation</Td>
                <Td>Neutral mental activity</Td>
                <Td>Neutral</Td>
              </tr>
              <tr>
                <Td className="font-medium text-neutral-900">Insomnolent mentation</Td>
          ...
          <P>
            He called this <strong className="text-neutral-900">super-somnolent mentation</strong>{' '}
          ...
          <blockquote className="border-l-4 border-neutral-200 pl-4 my-6 text-neutral-500 text-sm italic">
        ...
        <Section title="The randomized controlled trial">
          ...
          <P>
            <strong className="text-neutral-900">Full citation:</strong> Beaudoin, L.
          ...
          <Table>
            <tbody>
              ...
              <tr>
                <Td className="font-medium text-neutral-900">Sample</Td>
              ...
              <tr>
                <Td className="font-medium text-neutral-900">Conditions</Td>
                <Td>
              ...
              <tr>
                <Td className="font-medium text-neutral-900">Instruments</Td>
                <Td>
          ...
          <P>
            <strong className="text-neutral-900">Effect size interpretation:</strong>{' '}
          ...
          <P>
            <strong className="text-neutral-900">Notable contextual finding:</strong>{' '}
          ...
          <blockquote className="border-l-4 border-[#F2994A] pl-4 my-6 text-neutral-600 text-sm leading-relaxed">
            ...
            <footer className="mt-2 text-neutral-500 not-italic">
              — Beaudoin et al. (2016)
            </footer>
          </blockquote>
          <P>
        ...
        <Section title="Supporting mechanism evidence">
          ...
          <P>
            <strong className="text-neutral-900">Full citation:</strong> Haimov, I.
          ...
          <P>
            <strong className="text-neutral-900">Design:</strong> RCT, n=51 adults
            aged 65–85 with clinically diagnosed chronic insomnia. 8-week
            computerized cognitive training program vs. active control.
          </P>
          <P>
            <strong className="text-neutral-900">Key sleep findings:</strong>
          </P>
          <Table>
            <thead>
              <tr>
          ...
          <P>
            <strong className="text-neutral-900">Mechanism proposed:</strong> The
          ...
          <P>
            <strong className="text-neutral-900">Relevance to Drift:</strong> This
        ...
        <Section title="What the research does and does not show">
          <H3>What it shows</H3>
          <ul className="list-disc list-inside text-sm text-neutral-600 space-y-2 mb-6 leading-relaxed">
          ...
          <ul className="list-disc list-inside text-sm text-neutral-600 space-y-2 leading-relaxed">
            <li>
        ...
        <Section title="How Drift implements SDIT">
          ...
          <blockquote className="border-l-4 border-neutral-200 pl-4 my-6 text-neutral-600 text-sm leading-relaxed italic">
        ...
        <Section title="References">
          <ol className="list-decimal list-outside pl-5 text-sm text-neutral-600 space-y-3 leading-relaxed">
            <li>
              <strong className="text-neutral-900">Beaudoin, L.P., Digdon, N.,
            ...
            <li>
              <strong className="text-neutral-900">Beaudoin, L.P. (2013, updated
        ...
        <p className="text-sm text-neutral-500 mt-12 pt-8 border-t border-neutral-200">
          <Link href="/projects/drift" className="hover:text-neutral-600">
            ← Back to Drift
          </Link>
          {' · '}
          <Link
