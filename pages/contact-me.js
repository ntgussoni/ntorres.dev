...
const ContactIcons = () => {
  return (
    <div className="flex w-full h-auto justify-center mt-8 mb-8 ">
      <div className="p-1 mr-3 w-8">
        <a href="https://github.com/ntgussoni">
          <svg
      ...
      <div className="p-1 mr-3 w-8">
        <a href="https://dev.to/ntorresdev">
          <svg
            className="fill-current bg-current-white"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      <a href="https://www.linkedin.com/in/ntgussoni/">
  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col w-full sm:align-middle sm:justify-center p-4 mt-8">
        ...
        <p className="text-lg mb-1">Drop me a line, I'd love to talk to you</p>
        <ContactForm />
      </div>
    </Layout>
  );
